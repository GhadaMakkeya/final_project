      ...
      child: BlocConsumer<ForgetPasswordCubit, ForgetPasswordState>(
        listener: (context, state) {
          if (state is ForgetPasswordSuccess) {
            // Navigate first, then show snackbar so the user isn't blocked.
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => OtpScreen(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 32.h),
                  // ✅ Removed trailingIcon — it caused RenderFlex overflow
                  // because the button's Row (icon + label) exceeded the
                  // available width of 88.7px on some layouts. The label
